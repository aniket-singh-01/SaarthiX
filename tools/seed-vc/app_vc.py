...
def main(args):
    ...
    description = ("Zero-shot voice conversion with in-context learning. For local deployment please check [GitHub repository](https://github.com/Plachtaa/seed-vc) "
                   ...
                   "Zero-shot voice/singing conversion model without training required. For local deployment see [GitHub page](https://github.com/Plachtaa/seed-vc)<br>"
                   "Please note: reference audio will be automatically trimmed to 25 seconds if it exceeds this length.<br>If the total duration of source and reference audio exceeds 30 seconds, source audio will be processed in chunks.")
    inputs = [
